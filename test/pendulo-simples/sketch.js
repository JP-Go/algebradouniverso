...
function getInputs() {
  g = Number(document.querySelector("#g").value);
  L = Number(document.querySelector("#l").value);
  m = Number(document.querySelector("#m").value);
  ang_0 = Number(document.querySelector("#ang").value);
}
...
function resetLoop() {
  document.querySelector("#g").value = 9.81;
  document.querySelector("#l").value = 1;
  document.querySelector("#m").value = 100;
  document.querySelector("#ang").value = 30;
}
